 ...
 * |------+------+------+------+------+------|  Mute |    | Pause |------+------+------+------+------+------|
 * | ctrl |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |KC_SFTENT|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | ESC  | GUI | LALT  |spc   | /LOWER  /       \raise \  |bspc  | RCMD | ROPT | RCTL |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT( \
    ...
    KC_ESC,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                       KC_Y,     KC_U,     KC_I,    KC_O,    KC_P,    ARROW,
    KC_TAB,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                       KC_H,     KC_J,     KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_MUTE,   KC_MPLY,KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, LSFT_T(KC_ENTER),
                    KC_LGUI, KC_LALT, KC_LCTRL, KC_SPC ,   KC_LOWER,      KC_RAISE , KC_BSPC ,    KC_RCTRL, KC_RALT, KC_RGUI
),
/* LOWER
 * ,----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 */
[_LOWER] = LAYOUT(
LCTL(KC_GRV), _______, _______, _______, _______,  _______,                         _______, _______,   _______, _______,   _______,  _______,
    _______, KC_INS,  KC_PSCR, KC_APP,  XXXXXXX,  XXXXXXX,                         KC_PGUP, KC_PRVWD,  KC_UP,   KC_NXTWD,  KC_LSTRT, XXXXXXX,
    _______, KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE, KC_CAPS,                         KC_PGDN, KC_LEFT,   KC_DOWN, KC_RGHT,   KC_LEND,  XXXXXXX,
    _______, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX,  XXXXXXX, _______,       _______, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX,   XXXXXXX,  _______,
                      _______, _______, _______,  _______, _______,       _______, KC_DEL,  KC_DLINE,   _______, _______
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT(
    ...
    KC_GRV,  KC_1,   KC_EQL, KC_MINS, KC_PLUS,    KC_5,                            KC_6,    KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, XXXXXXX,
    _______, KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, _______,       _______, KC_PIPE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
